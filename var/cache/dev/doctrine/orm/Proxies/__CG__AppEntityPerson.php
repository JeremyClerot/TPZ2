...
class Person extends \App\Entity\Person implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Person' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Person' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Person' . "\0" . 'age', '' . "\0" . 'App\\Entity\\Person' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\Person' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Person' . "\0" . 'color'];
        }
